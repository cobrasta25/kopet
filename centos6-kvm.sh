...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "http://zhangzi-ssh.online/debian7/repo/screenfetch"
...
wget -O /home/vps/public_html/index.html "http://zhangzi-ssh.online/debian7/repo/index.html"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "http://zhangzi-ssh.online/debian7/repo/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "http://zhangzi-ssh.online/debian7/repo/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "http://zhangzi-ssh.online/debian7/repo/snmpd.conf"
wget -O /root/mrtg-mem.sh "http://zhangzi-ssh.online/debian7/repo/mrtg-mem.sh"
...
curl "http://zhangzi-ssh.online/debian7/repo/mrtg.conf" >> /etc/mrtg.cfg
...
echo "OPTIONS=\"-b /etc/bannerssh -p 80 -p 443 -p 2000 -p 22507\"" > /etc/sysconfig/dropbear
echo "/bin/false" >> /etc/shells
service dropbear restart
chkconfig dropbear on

# bannerssh
wget http://zhangzi-ssh.online/centos6/bannerssh.net
...
# install webmin
cd
wget "http://zhangzi-ssh.online/debian7/repo/webmin-1.801-1.noarch.rpm"
...
#download script
cd /usr/bin
wget -O menu.tar.gz "http://zhangzi-ssh.online/centos6/menu/menu.tar.gz"
tar -xvf menu.tar.gz
rm -f menu.tar.gz
...
# bannerssh
wget http://zhangzi-ssh.online/debian7/bannerssh
...
wget http://zhangzi-ssh.online/debian7/repo/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
...
echo "   - Dropbear    :80, 110, 443"  | tee -a log-install.txt
